...
//        {
//            var user = User.Create(Identity, "Tony", "Stark", UserRole.Buyer, "tony@beddin.ng");
...
//        {
//            var user = User.Create(Identity, "Tony", "Stark", UserRole.Buyer, "tony2@beddin.ng");
//            await _repo.AddAsync(user, default);
//            await DbContext.SaveChangesAsync();
...
//        {
//            var user = User.Create(Identity, "Tony", "Stark", UserRole.Buyer, "getbyemail@beddin.ng");
//            await _repo.AddAsync(user, default);
//            await DbContext.SaveChangesAsync();
...
//        {
//            var user = User.Create(Identity, "Tony", "Stark", UserRole.Buyer, "case@beddin.ng");
//            await _repo.AddAsync(user, default);
//            await DbContext.SaveChangesAsync();
